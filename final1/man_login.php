		...
		<div class="advantages-main">
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
                    ...
                    <div id="success"></div>
                        ...
                        <a class="btn btn-primary" href="user-login.php" type="button">使用者登入</a>
                        <?php echo $error; ?>
          ...
          <?php
            ...
            if(isset($_POST['account'])){
                ...
                $sql1 = "SELECT * FROM teacher WHERE account = '$id'AND categories=0";
                $result1 = mysqli_query($link, $sql1);
                while($row = mysqli_fetch_array($result1)){
                    if($row["manager_pasw"] == $manager_pasw){
                        $_SESSION["ac_name_ma"] = $row["manager_name"];
                        $_SESSION["ac_level"] = $row["categories"];
                        header("Location:user_sr_lr.php");
                    }
                }

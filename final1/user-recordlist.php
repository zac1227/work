				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="classroom.php" class="menu__link ">教室預覽</a></li>
							<li class="menu__item"><a href="user-recordlist.php" class="menu__link ">預借紀錄</a></li>
							<li class="menu__item"><a href="contact.php" class="menu__link ">聯絡我們</a></li>
						
							<li class="menu__item"><a href="home.php" class="menu__link ">登出</a></li>

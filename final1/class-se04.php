	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>進修部</h4>
				<p class="contact-agile2">Training Department College</p>
				<form action="#" method="post" name="sentMessage" id="contactForm" novalidate>
					<img src="images/進修部.jpg" style="width:400px ; height: 350px;margin-left: 39px;margin-right: 39px" t="">	
				</form>            
			</div>
		</div>
			...
			<form action="#" method="post">
					...
					<div class=" form-date-w3-agileits">
                           <p style="color: white">教室</p>
                            ...
                            <option value="進修部大樓 ES101">進修部大樓 ES101</option>
                            <option value="進修部後大樓 ES317">進修部後大樓 ES317</option>

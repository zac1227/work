<?php
    if(isset($_POST["room_day"])){
        ...
        include("dblink.php");
        $sql = "INSERT INTO `semesterrecord` (`building`,`room_day`, `room_avail_start`, `room_avail_end`) VALUES ('$building','$room_day','$room_avail_start', '$room_avail_end');";
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>傳播學院</h4>
				<p class="contact-agile2">Communication college</p>
				<form action="#" method="post" name="sentMessage" id="contactForm" novalidate>
					<img src="images/文友樓.jpg" style="width:400px ; height: 350px;margin-left: 39px;margin-right: 39px" t="">	
				</form>            
			</div>
		</div>
			...
			<form action="#" method="post">
					...
					<div class=" form-date-w3-agileits">
                           <p style="color: white">教室</p>
                            ...
                            <option value="文開樓LE404A">文開樓LE404A</option>
                            <option value="文友樓LF101">文友樓LF101</option>
                            <option value="文華樓LI202">文華樓LI202</option>
                            <option value="公博樓LG303">公博樓LG303</option>

<?php
	 ...
	 $manager_pasw = $_GET['manager_pasw'];
	 $manager_name = $_GET['manager_name'];
	 if(isset($_POST["manager_pasw"])){
		 $manager_pasw1 = $_POST["manager_pasw"];
		...
		$sql = "UPDATE `teacher` SET `categories` = '$categories1', `manager_pasw` = '$manager_pasw1' WHERE `teacher`.`id` = '$id'";
				...
				<form action="#" method="post" >
				    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="name"  value="<?php echo $manager_name ?>" disabled>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="password" class="form-control" name="manager_pasw"  value="<?php echo $manager_pasw ?>">

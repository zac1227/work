			...
			<form action="#" method="post">
					...
					<div class=" form-date-w3-agileits">
                           <p style="color: white">選擇教室</p>
                            ...
                            <option value="外語學院LA101">外語學院LA101</option>
                            <option value="外語學院LB202">外語學院LB202</option>
                            <option value="外語學院LC303">外語學院LC303</option>
                            <option value="聖言樓SF440">聖言樓SF440</option>
                            <option value="外語學院AV101">外語學院AV101</option>
                            <option value="外語學院FL220">外語學院FL220</option>
                            <option value="外語學院FG330">外語學院FG330</option>

...
<!-- //header -->
	...
	<div id="home" class="w3ls-banner">
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Select </h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/外語學院.jpg" alt=" " class="img-responsive" style="width:255px ; height: 255px"/>
							<h4><strong>外語學院</strong></h4>
						</div>
						<div class="price-gd-bottom">
							   
							<div class="price-selet">	
														
								<a href="class-nor01.php">選擇</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/管理學院.jpg" alt=" " class="img-responsive" style="width:255px ; height: 255px"/>
							<h4><strong>管理學院</strong></h4>
						</div>
						<div class="price-gd-bottom">
							
							<div class="price-selet">
								<!--h3 data-brackets-id="2521"><span data-brackets-id="2522">$</span>220</h3-->
								<a href="class-nor02.php" >選擇</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/文友樓.jpg" alt=" " class="img-responsive" style="width:255px ; height: 255px"/>
							<h4><strong>傳播學院</strong></h4>
						</div>
						<div class="price-gd-bottom">
							
							<div class="price-selet">
								
								<a href="class-nor03.php">選擇</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
						<div class="price-gd-top ">
							<img src="images/進修部.jpg" alt=" " class="img-responsive" style="width:255px ; height: 255px"/>
                            <h4><strong>進修部</strong></h4>
						</div>
						<div class="price-gd-bottom">
							
							<div class="price-selet">
								
								<a href="class-nor04.php" >選擇</a>
							</div>
						</div>
					</div>
				</div>

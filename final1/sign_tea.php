<?php
	 if(isset($_POST["account"])){
		 ...
		 include("dblink.php");
		  ...
		  $sql = "INSERT INTO `account` (`account`, `password`, `name`, `categories`) VALUES ('$account', '$password', '$name','$categories');";
		 $result = mysqli_query($link, $sql);
		  echo "<script>alert('您已新增此筆資料!'); location.href = 'man_acc.php';</script>";
		 mysqli_close($link);
		 }
?>
<!DOCTYPE php>
